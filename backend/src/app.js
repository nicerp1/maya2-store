...
app.use((err,_req,res,_next)=>{console.error(err);res.setHeader('X-Maya-Error-Type',err?.name||'Error');fail(res,process.env.NODE_ENV==='production'?'خطای داخلی سرور':err.message,500);});
